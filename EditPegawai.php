...
//   echo $SQL ."<br>" ;
  ...
  $userID=$_GET["spegawaiID"];
  $SQL ="SELECT * FROM pegawai WHERE pegawaiID='$userID' " ;
  $result =mysqli_query($koneksi,$SQL);
  $user = mysqli_fetch_row($result);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
	...
	<table width="100%" border="0">
          ...
          <form action="" name="" method="post" onSubmit="return valid()"  >
         ...
         ?>
           ...
           <tr>
             ...
             <tr>  
              ...
              <td bgcolor="#c2c2a3"  >:</td>
              <td bgcolor="#c2c2a3"  ><input type="date" name="sTGL_mulai_bekerja" value="<?php echo $userLain[4]?>"    size="40" >
              </td>
            </tr>
         ...
         ?>
            ...
            <tr>
              ...
              <td bgcolor="#c2c2a3"  >:</td>
              <td bgcolor="#c2c2a3"  ><input type="text" name="sTahun_Masuk" value="<?php echo $userLain[15]?>"  size="40" >
              </td>
            </tr>
             <tr>
              <td bgcolor="#c2c2a3"  >Password </td>
              <td bgcolor="#c2c2a3"  >:</td>
              <td bgcolor="#c2c2a3"  ><input type="text" name="spassword" value="<?php echo $userLain[8] ?>"  size="40" >
              </td>
            </tr>
          ...
          ?>
            ...
            <tr>
              ...
              <td bgcolor="#c2c2a3"  >&nbsp;</td>
              <td bgcolor="#c2c2a3"  ><input type="text" name="stingkat" value="<?php echo $userLain[17]?>"  size="40" >
            </tr></td>

            <tr>
              <td bgcolor="#c2c2a3"  >Tahun </td>
              <td bgcolor="#c2c2a3"  >:</td>
              <td bgcolor="#c2c2a3"  ><input type="text" name="stahun" value="<?php echo $userLain[18]?>"  size="40" >
              </td>
            </tr>
  ...
  <script>
      function changePage() {
          var id = document.getElementById("sNAMA");
          window.location = "EditPegawai.php?spegawaiID=" + id.value;
      }
  </script>
</body>
</html>
